#!/usr/bin/env python3
"""rigor.py — classical statistical inference, verified and citable.
...
Commands:
    rigor.py ttest one-sample --data 1,2,3 --mu0 0
    rigor.py ttest two-sample --a 1,2,3 --b 4,5,6 [--equal-var]
    rigor.py ttest paired --a 1,2,3 --b 4,5,6
    rigor.py ztest one-proportion --successes 45 --n 100 --p0 0.5
    rigor.py ztest two-proportion --successes1 80 --n1 100 --successes2 20 --n2 100
    rigor.py chi2 goodness-of-fit --observed 5,8,9 --expected 10,10,10
    rigor.py chi2 independence --table "10,20;30,40"
    rigor.py anova --groups "1,2,3|4,5,6|7,8,9"
    rigor.py effect-size cohens-d --a 1,2,3 --b 4,5,6
    rigor.py effect-size cohens-h --p1 0.6 --p2 0.3
    rigor.py effect-size cramers-v --chi2 10 --n 100 --rows 2 --cols 2
    rigor.py power ttest-2samp --effect-size 0.5 --power 0.8      # -> required n
    rigor.py power ttest-2samp --effect-size 0.5 --n 64           # -> achieved power
    rigor.py power proportion --p1 0.5 --p2 0.4 --power 0.8
    rigor.py correct bonferroni --p 0.01,0.02,0.03,0.04
    rigor.py correct bh --p 0.01,0.02,0.03,0.04
"""
import argparse
import math
import sys
